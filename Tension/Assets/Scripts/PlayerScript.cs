...
public class PlayerScript : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        tankcontroller = GameObject.Find("Tank Main Body").GetComponent<TankController>();
    ...
    void Update()
    {
        ...
        if (canMove)
        {
            ...
            playerCamera.transform.localRotation = Quaternion.Euler(rotationX, 0, 0);//y=0.5 is touching the ground
